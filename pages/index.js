...
export default function Home({ repoURL }) {
	...
	return (
		<Page>
			...
			<div className="links">
				<a href="https://www.paypal.me/DimitarNestorov" target="_blank" rel="noopener">
					<svg
						aria-hidden="true"
						focusable="false"
						role="img"
				...
				<a href="/discord" target="_blank" title="Let's chat on Discord" rel="noopener">
				...
				<a
					href="https://twitter.com/dimitarnestorov"
				...
				<a
					href="https://github.com/dimitarnestorov"
				...
				<a
					href="https://linkedin.com/in/dimitarnestorov/"
